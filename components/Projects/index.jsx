...
const projects = [
  {
    ...
    src: "prof.png",
    color: "#000000",
    link: "/proj/tassignment"
  },
  {
    title: "Optimized Threadpool",
    src: "benchmark.png",
    color: "#8C8C8C"
  },
  {
  ...
  {
    title: "DNN Movie Recommender System-IN PROGRESS",
    src: "recommender.png",
    color: "#706D63"
  }
]
    ...
    <>
        <MotionDiv ref={modalContainer} variants={scaleAnimation} initial="initial" animate={active ? "enter" : "closed"} className={styles.modalContainer}>
            <div style={{top: index * -100 + "%"}} className={styles.modalSlider}>
            {
                ...
                return <div className={styles.modal} style={{backgroundColor: color}} key={`modal_${index}`} onClick={() => handleModalClick(index)}>
                    <Image 
                    src={`/images/${src}`}
                    width={300}
                    height={0}
